...
Check out the :doc:`installation` section for further information one 
how to install LavAtmos. Once installed, head over to :doc:`getstarted`
for some initial examples on how to use the code.
